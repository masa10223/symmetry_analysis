...
In either case, the next click on the Binarize button will fill the largest of the displayed rectangular areas.　Tweak the number so that this equals the expression area.